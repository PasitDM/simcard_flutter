...
class PhoneInformationsScreen extends StatefulWidget {
  const PhoneInformationsScreen({super.key});

  @override
  State<PhoneInformationsScreen> createState() =>
      PphonIinformationsStateScreen();
}

class PphonIinformationsStateScreen extends State<PhoneInformationsScreen> {
  String model = "";
